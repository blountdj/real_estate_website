...
const Expertise = () => {
    ...
    return (
        <>
            ...
            <BackgroundHeader page="expertise" section="expertise" h1_type="_1" h1="services for property owners"/>
            <Info 
                page="expertise"
                index="0"
                ...
                button_link="/contact"
            />
            <BackgroundHeader page="expertise2" section="expertise2" h1_type="_1" h1="services for visitors"/>
            <Info 
                page="expertise"
                index="1"
