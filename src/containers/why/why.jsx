...
const Why = () => {
  return (
    <section className="why flex-center flex-center-column" id="why">
        <div className="why_text flex-center flex-center-column">
        ...
        <div className="why_components flex-center flex-center-row">
        ...
        <button className="button button-black">find out more</button>
    </section>
  )
};
